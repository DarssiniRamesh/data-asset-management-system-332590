...
// PUBLIC_INTERFACE
export function DataInputTab({ caps }: AssetDetailsTabProps) {
  /** Contract:
   * Purpose:
   *  - Data Input values are scoped to (assetId, inputParameterId).
        ...
        <div className="mt-4 rounded-2xl bg-slate-50 p-4 text-sm text-slate-700 dark:bg-slate-900/60 dark:text-slate-200">
          ...
          <div className="muted mt-2 text-xs">
            ...
            <code className="font-mono">
              /api/assets/{`{assetId}`}/input-parameters/{`{inputParameterId}`}/data-input-values
            </code>
            .
          </div>
        </div>
