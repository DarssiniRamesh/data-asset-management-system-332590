...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      {/* 
        Layout note:
        - The outer container provides full-height + vertical centering so the form/card doesn't feel top-heavy
          or leave a large empty area below.
        - Auth behavior is unchanged; this is strictly layout/styling.
      */}
      <div className="mx-auto flex min-h-screen max-w-6xl items-center px-6 py-10 lg:py-16">
        <div className="grid w-full grid-cols-1 items-center gap-6 lg:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white/50 p-8 shadow-soft backdrop-blur dark:border-slate-800 dark:bg-slate-950/40">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-slate-600 dark:text-slate-300">
                Sign in to manage assets, configure modules, validate mappings, and generate throughput setups — all
                backed by a role-based ASP.NET Core API.
              </p>
          ...
          {/* Right panel */}
          <div className="mx-auto w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-soft dark:border-slate-800 dark:bg-slate-950 lg:max-w-none">
